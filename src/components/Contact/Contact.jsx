...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_wkl0q44', 'template_4pqpgfg', form.current, 'VKeBnkksELG-Jnap_')
    e.target.reset()
  }
        ...
        <div className="contact__content">
          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <span className="contact__card-data">pritamdey2001@gmail.com</span>

              <a href="mailto:pritamdey2001@gmail.com" className="contact__button">
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">+91 89815 89735</span>

              <a href="https://wa.me/+918981589735" className="contact__button" target="_blank" rel="noreferrer">
                Write Me <i className="bx bx-right-arrow-alt contact__button-icon"></i>
              </a>
            </div>
            ...
            <div className="contact__card">
              ...
              <h3 className="contact__card-title">Messeneger</h3>
              <span className="contact__card-data">ride.with.silvi</span>

              <a href="https://m.me/ride.with.silvi" className="contact__button" target="_blank" rel="noreferrer">
                Write Me <i className="bx bx-right-arrow-alt contact__button-icon"></i>
              </a>
            </div>
          </div>
