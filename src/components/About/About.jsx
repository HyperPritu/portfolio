...
import cv from '../../assets/Pritam-Cv.pdf'
    ...
    <section className="about section" id="about">
      ...
      <div className="about__container container grid">
        ...
        <div className="about__data">
          <Info />
          <p className="about__description">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iste reiciendis ipsam quibusdam aspernatur repudiandae, aut numquam amet commodi distinctio corporis mollitia officia corrupti totam, optio doloribus, maxime deserunt! Assumenda, tempora.</p>
