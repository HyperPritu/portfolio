          ...
          <ul className="nav__list grid">
            <li className="nav__item">
              <a
                ...
                className={activeNav === '#home' ? 'nav__link active' : 'nav__link'}>
            ...
            <li className="nav__item">
              <a
                ...
                className={activeNav === '#skills' ? 'nav__link active' : 'nav__link'}>
            ...
            <li className="nav__item">
              <a
                ...
                className={activeNav === '#qualification' ? 'nav__link active' : 'nav__link'}>
